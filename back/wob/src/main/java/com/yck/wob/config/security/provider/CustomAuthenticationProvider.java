package com.yck.wob.config.security.provider;


import com.yck.wob.config.security.service.CustomUserDetailsServiceImpl;
...
public class CustomAuthenticationProvider implements AuthenticationProvider{
    ...
    @Autowired private UserDetailsService customUserDetailsServiceImpl;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        UserDetails loadedUser = customUserDetailsServiceImpl.loadUserByUsername(username);
        if(loadedUser == null)
